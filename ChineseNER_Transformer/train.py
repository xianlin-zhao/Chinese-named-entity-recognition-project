...
from utils import *
from  seq2seq import Encoder,Attention
...
def main():
    ...
    parser.add_argument('--model_path', default='./model/transformer.pt', help='The model will be saved to this path.', type=str)
    ...
    # Model configs
    parser.add_argument('--emb_dim', default=256, help='Tokens will be embedded to a vector.', type=int)
    ...
    # Training configs
    parser.add_argument('--train_batch_size', default=32, help='Batch size for training.', type=int)
    parser.add_argument('--test_batch_size', default=1, help='Batch size for testing.', type=int)
    parser.add_argument('--num_epochs', default=30, help='Batch size for training.', type=int)
    ...
    en1=Encoder(args)
    en2=Encoder(args)
    model=Attention(args,en1,en2,tag2id)
