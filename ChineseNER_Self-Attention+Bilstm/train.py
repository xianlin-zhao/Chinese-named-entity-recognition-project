...
def main():
    ...
    parser.add_argument('--model_path', default='./model/self-attention-bilstm.pt', help='The model will be saved to this path.', type=str)
    ...
    en1=Encoder(args)
    Attention1=Attention(args,en1,tag2id)
    model=BiLSTM(args,Attention1)
